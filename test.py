...
import IPython
IPython.embed()
# # file_path = "/m-ent1/ent1/xihc20/ALL_DATA_PREPROCESSING/Divide_Into_Months/training_data/mode_y/y=2016/y=01/data.txt"
# #
...
# print(time.asctime(time.localtime()))
#
# with open('/m-ent1/ent1/xihc20/ALL_DATA_PREPROCESSING/Extract_Relation/Words_PMID/Single_intersection/BioLAMA/umls/UR116/Object_dict.json') as f:
#     Object_dict = json.load(f)
#
# with open('/m-ent1/ent1/xihc20/ALL_DATA_PREPROCESSING/Extract_Relation/Words_PMID/Exact_intersection/BioLAMA/umls/UR116/Object_dict.json') as f:
...
# #     cnt += 1
# #     if len(Object_dict[key]) > len(New_Object_dict[key]):
# #         # IPython.embed()
# #         print(len(Object_dict[key]), len(New_Object_dict[key]))
# #
# #         if len(Object_dict[key]) == 296:
# #             IPython.embed()
# #     else:
# #         assert len(Object_dict[key]) == len(New_Object_dict[key])
# #
# # values = []
